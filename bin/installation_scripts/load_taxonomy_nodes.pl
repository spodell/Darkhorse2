...
# Compose creation command
	...
	{		
		$sql = qq(CREATE TABLE `nodes` (
  `tax_id` int(11) NOT NULL default '0',
  `parent_tax_id` int(11) default NULL,
  `rank` varchar(100) default NULL,
  `embl_code` varchar(10) default NULL,
  `division_id` int(11) default NULL,
  `inherited_div_flag` int(11) default NULL,
  `genetic_code_id` int(11) default NULL,
  `inherited_GC_flag` int(11) default NULL,
  `mitochondrial` int(11) default NULL,
